...
const help = `${ansiCyan}${ansiBold}${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}#############################################################################${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}#                                                                           #${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}#                                   tfxjs                                   #${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}#                                                                           #${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}#############################################################################${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}${ansiResetDim}${ansiDefaultForeground}${ansiLtGray}${ansiDefaultForeground}\n${ansiLtGray}tfxjs cli tool allows you to run tfxjs tests.${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}${ansiBold}To test a .js file:${ansiResetDim}\n${ansiBold}${ansiResetDim}${ansiCyan}  $ tfx <file_path>${ansiDefaultForeground}\n${ansiCyan}${ansiDefaultForeground}\n${ansiCyan}${ansiDefaultForeground}${ansiLtGray}${ansiBold}To create tests from a terraform plan:${ansiResetDim}${ansiDefaultForeground}\n${ansiLtGray}${ansiBold}${ansiResetDim}${ansiDefaultForeground}${ansiCyan}  $ tfx plan --in <terraform file path> --out <filepath> --type <tfx or yaml>${ansiDefaultForeground}\n${ansiCyan}${ansiDefaultForeground}\n${ansiCyan}${ansiDefaultForeground}${ansiLtGray}${ansiBold}Additional flags are also available:${ansiResetDim}${ansiDefaultForeground}\n${ansiLtGray}${ansiBold}${ansiResetDim}${ansiDefaultForeground}${ansiCyan}  -v | --tf-var${ansiDefaultForeground}\n${ansiCyan}${ansiDefaultForeground}${ansiLtGray}      Inject a terraform.tfvar value into the plan. This flag can be added any number of times${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}${ansiBold}To create a nodejs test file from a YAML plan:${ansiResetDim}\n${ansiBold}${ansiResetDim}${ansiCyan}  $ tfx decode <yaml file path> --out <filepath>${ansiDefaultForeground}\n${ansiCyan}${ansiDefaultForeground}\n${ansiCyan}${ansiDefaultForeground}${ansiLtGray}${ansiBold}Additional flags are also available:${ansiResetDim}${ansiDefaultForeground}\n${ansiLtGray}${ansiBold}${ansiResetDim}${ansiDefaultForeground}${ansiCyan}  -v | --tf-var${ansiDefaultForeground}\n${ansiCyan}${ansiDefaultForeground}${ansiLtGray}      Inject a terraform.tfvar value into the plan. This flag can be added any number of times${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}`;
