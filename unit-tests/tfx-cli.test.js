...
const help = `${ansiCyan}${ansiBold}${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}#############################################################################${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}#                                                                           #${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}#                                   tfxjs                                   #${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}#                                                                           #${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}#############################################################################${ansiResetDim}${ansiDefaultForeground}\n${ansiCyan}${ansiBold}${ansiResetDim}${ansiDefaultForeground}${ansiLtGray}${ansiDefaultForeground}\n${ansiLtGray}tfxjs cli tool allows you to run tfxjs tests.${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}\n${ansiLtGray}To test a .js file:${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}${ansiYellow}  $ tfx <file_path>${ansiDefaultForeground}\n${ansiYellow}${ansiDefaultForeground}\n${ansiYellow}${ansiDefaultForeground}${ansiLtGray}To create tests from a terraform plan:${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}${ansiYellow}  $ tfx plan --in <terraform file path> --out <filepath> --type <tfx or yaml>${ansiDefaultForeground}\n${ansiYellow}${ansiDefaultForeground}\n${ansiYellow}${ansiDefaultForeground}${ansiLtGray}Additional flags are also available:${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}${ansiYellow}  -v | --tf-var${ansiDefaultForeground}\n${ansiYellow}${ansiDefaultForeground}${ansiLtGray}      Inject a terraform.tfvar value into the plan. This flag can be added any number of times${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}\n${ansiLtGray}To create a nodejs test file from a YAML plan:${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}${ansiYellow}  $ tfx decode <yaml file path> --out <filepath>${ansiDefaultForeground}\n${ansiYellow}${ansiDefaultForeground}\n${ansiYellow}${ansiDefaultForeground}${ansiLtGray}Additional flags are also available:${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}${ansiYellow}  -v | --tf-var${ansiDefaultForeground}\n${ansiYellow}${ansiDefaultForeground}${ansiLtGray}      Inject a terraform.tfvar value into the plan. This flag can be added any number of times${ansiDefaultForeground}\n${ansiLtGray}${ansiDefaultForeground}`;
