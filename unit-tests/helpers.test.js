...
describe("helpers", () => {
  ...
  describe("checkResourceTests", () => {
    it("should throw an error if test is passed with no name", () => {
      ...
      assert.throws(test, `Tests object requires \`name\` and \`test\` parameter. Got {\n  "address": "test"\n}`)
    })
    ...
    it("should throw an error if test is passed values array", () => {
      ...
      assert.throws(test, `Values fields for test objects must be type object, got Array:\n{\n  "name": "test",\n  "address": "test",\n  "values": [\n    1,\n    2,\n    3,\n    4\n  ]\n}`)
    })
    it("should throw an error if test is passed not object and not array", () => {
      ...
      assert.throws(test, `Values fields for test objects must be type object, got number:\n{\n  "name": "test",\n  "address": "test",\n  "values": 1\n}`)
    })
