...
`
      ...
      return extract.planTfx("Template Name", "path", "tfx", {}, overrideExec, false, (data) => {
...
`
      ...
      let overrideExec = mockExec.promise;
      return extract.planTfx("Template Name", "path", "tfx", {}, overrideExec, true, (data) => {
        assert.deepEqual(data, expectedFile, "should return data")
      })
    });
...
`
      ...
      let overrideExec = mockExec.promise;
      return extract.planTfx("Template Name", "path", "yaml", {}, overrideExec, false, (data) => {
        assert.deepEqual(data, expectedFile, "should return data")
      })
    })
  })
