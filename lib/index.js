...
const { containsKeys, checkResourceTests } = require("./helpers.js");
const { testHead } = require("./builders.js");
const { eachKey, containsCheck, typeCheck } = require("./utils.js");
<<<<<<< HEAD
=======
...
=======
  ...
  this.connect = new builders.connect(connect, {
    ssh: containsKeys(options, "overrideSSH") ? options.overrideSSH : ssh,
    ping: containsKeys(options, "overridePing") ? options.overridePing : ping,
    exec: containsKeys(options, "overrideExec") ? options.overrideExec : exec
  }); // Connect template
>>>>>>> intern-tfxjs/master
  ...
  this.cli = new tfCli(
    ...
    containsKeys(options, "overrideExec") ? options.overrideExec : exec,
    // If exec is overridden or quiet is passed, disable logs
    containsKeys(options, "overrideExec") || containsKeys(options, "quiet")
      ? false
      : this.enableLogs
  );
