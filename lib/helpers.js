  ...
  checkModuleTest: function (address, tfPlan) {
    ...
    try {
      ...
      if (
        ...
        throw new Error(
          chalk.red("Expected root module to have resources. Check your plan configuration and try again.")
        );
      } else if (parentAddress === "" && moduleData.resources.length === 0) {
        // If root module doesn't have objects
        throw new Error(
          chalk.red("Expected root_modules to contain at least one resource. Check your plan configuration and try again.")
        );
      } else if (
        ...
        throw new Error(
          chalk.red("Expected child_modules to be created. Check your plan configuration and try again.")
        );
      }
    } catch (err) {
      ...
      if (tfPlan.root_module == undefined) {
        ...
        throw new Error(
          chalk.red("Expected terraform plan to have root_module at top level. Check your plan configuration and try again.")
        );
      } else if (
        ...
        throw new Error(
          chalk.red("Expected terraform plan root_module to have child_modules. Check your plan configuration and try again.")
        );
      } else {
