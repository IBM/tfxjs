...
const utils = function (options) {
  ...
  this.it = keysContains(options, "overrideIt") ? options.overrideIt : it;
  this.describe = keysContains(options, "overrideDescribe")
    ? options.overrideDescribe
    : describe;
  this.assert = keysContains(options, "overrideAssert")
