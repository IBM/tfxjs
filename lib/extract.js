...
const extract = {
  ...
  planResourceTest: function (
    ...
    const resourceAddressRegExp = new RegexButWithWords()
      ...
      .done("g");
    const resourceAddressSlashesRegExp = new RegexButWithWords()
      .literal('"')
      .done("g");
    ...
    let resourceAddress =
      ...
      resource.address
        ...
        .replace(resourceAddressSlashesRegExp, '\\"'); // Resource Address
    // List of values
  ...
  moduleTest: function (
    ...
    const outputDataRegExp = new RegexButWithWords()
      .literal("tfx.module(")
      .whitespace()
      .oneOrMore()
      .literal('"')
      ...
      .literal(");")
      .done("g");
    if (outputType !== "yaml" && outputData.match(outputDataRegExp)) {
      outputData = "";
    }
    ...
    const newLineRegExp = new RegexButWithWords()
      .newline()
      .whitespace()
      .anyNumber()
      .newline()
      .oneOrMore()
      .done("g");
    const doubleNewlineRegExp = new RegexButWithWords()
      .literal(";")
      .newline()
      .look.ahead((exp) => {
        exp.literal("tfx");
    ...
    if (typeof outputData === "string")
      outputData = outputData
        ...
        .replace(doubleNewlineRegExp, ";\n\n");
    // If is submodule or tfx, return raw output, otherwise yaml stringify sata
    const yamlRegExp = new RegexButWithWords().look
      .behind((exp) => {
        exp.whitespace();
      })
      .literal('"')
    ...
    return isSubModule || outputType === "tfx"
      ...
      : "\n" +
          YAML.stringify(outputData)
            .replace(yamlRegExp, "") // remove quotes around string type variables and also escaped slashes
  ...
  deyamilfy: function (yamlFileData, tfvars) {
    ...
    eachKey(jsonData, (key) => {
      if (key !== "tfxPlan") {
        ...
        const spacesRegExp = new RegexButWithWords()
          .whitespace()
          .whitespace()
          .look.ahead((exp) => {
            exp.literal("{");
        ...
        jsTestTemplate.set(
          ...
          matchSpace(1, prettyJSON(overrideTfvars)).replace(spacesRegExp, "")
        );
      }
    });
