  ...
  planResourceTest: function (
    ...
    let resourceAddress =
      ...
      resource.address
        ...
        .replace(new RegexButWithWords().literal("\"").done("g"), '\\"'); // Resource Address
    // List of values
          ...
          YAML.stringify(outputData)
            .replace(
              new RegexButWithWords().look
                ...
                .done("g"),
              ""
            ) // remove quotes around string type variables and also escaped slashes
            .replace(new RegexButWithWords().literal('\\\\\\"').done("g"), '"'); // replace escaped quotes with single quotes
  },
