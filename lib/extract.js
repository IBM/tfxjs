...
function stateResourceTest(moduleName, moduleData) {
  ...
  addressTests += "\n);";
  return text.fill(`"${moduleName}"`, addressTests);
}
 ...
 */
function applyTfx(tfState) {
  let moduleMap = {
    root_module: [],
  };
  let applyText = `tfx.apply("tfxjs generated tests, () => {\n  `;
  ...
  return applyText.replace(/\s+(?=$)/g, "\n});\n");
}

module.exports = {
  planResourceTest: planResourceTest,
  moduleTest: moduleTest,
  fileDataCallback: fileDataCallback,
  planTfx: planTfx,
  deyamilfy: deyamilfy,
  applyResourceTest: applyResourceTest,
  stateResourceTest: stateResourceTest,
  applyTfx: applyTfx,
};
