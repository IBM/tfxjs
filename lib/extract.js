...
const extract = {
   ...
   */
  planTfx: function (templateName, templatePath, type, tfvars, exec, callback) { // add a variable so that 
    let cli = new tfCli(templatePath, exec, true); // this true is a variable 
    return cli.plan(
      tfvars,
      (planData) => {
