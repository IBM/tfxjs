...
module.exports = {
  ...
  messages: {
    ...
    errors: {
      no_root_resources: "Expected root module to have resources. Check your plan configuration and try again.",
      no_root_module_resources: "Expected root_modules to contain at least one resource. Check your plan configuration and try again.",
      no_child_modules: "Expected child_modules to be created. Check your plan configuration and try again.",
      undefined_root_module: "Expected terraform plan to have root_module at top level. Check your plan configuration and try again.",
      undefined_child_modules: "Expected terraform plan root_module to have child_modules. Check your plan configuration and try again."
    }
  },
};
