...
module.exports = {
  ...
  fileNameRegExp: new RegexButWithWords()
    ...
    .done("g"),
  errors: {
    no_resources_root_module: "Expected root module to have resources. Check your plan configuration and try again.",
    no_resources_in_root_module_list:  "Expected root_modules to contain at least one resource. Check your plan configuration and try again.",
    no_parent_address_no_child_modules: "Expected child_modules to be created. Check your plan configuration and try again.",
    no_root_module: "Expected terraform plan to have root_module at top level. Check your plan configuration and try again.",
    no_parent_no_root_no_child_modules: "Expected terraform plan root_module to have child_modules. Check your plan configuration and try again."
  }
};
