...
`);
  ...
  connect: function (connect, connectionPackages) {
    ...
    this.ping = {
      doesConnect: (testName, host) => {
        return this.connectionTests.pingTest(testName, host);
      },
      doesNotConnect: (testName, host) => {
        return this.connectionTests.pingTest(testName, host, true);
      }
    },
    this.ssh = {
      doesConnect: (testName, host, username, privateKey) => {
        return this.connectionTests.sshTest( testName, host, username, privateKey)
      },
      doesNotConnect: (testName, host, username, privateKey) => {
        return this.connectionTests.sshTest(
          testName,
          host,
          username,
          privateKey,
