...
const builders = {
  ...
  notFalseTest: function (name, assertionArgs) {
    paramTest(builders.notFalseTest, arguments, {
      name: "string",
      assertionArgs: "Array",
    });
  ...
  isTrueTest: function (name, assertionArgs) {
    paramTest(builders.isTrueTest, arguments, {
      name: "string",
      assertionArgs: "Array",
    });
  ...
  deepEqualTest: function (name, assertionArgs) {
    paramTest(builders.deepEqualTest, arguments, {
      name: "string",
      assertionArgs: "Array",
    });
  ...
  eval: function (appendMessage, evaluationFunction) {
    paramTest(builders.eval, arguments, {
  ...
  resource: function (name, address, values) {
    paramTest(builders.resource, arguments, {
      name: "string",
      address: "string",
      values: "object",
    });
  ...
  address: function (address, ...instances) {
    paramTest(builders.address, arguments, { address: "string" });
    arrTypeCheck(
