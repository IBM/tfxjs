 ...
 * @param {Object} connectionPackages.ssh ssh package: either the mock or the node-ssh package
 * @param {Object} connectionPackages.ping ping package: either the mock or the real ping package 
 */
const connect = function (connectionPackages) {
   ...
   * @param {boolean} doesNotConnect represents expected behavior 
